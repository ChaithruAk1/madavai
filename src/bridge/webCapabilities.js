...
export const CAPABILITIES = {
  ...
  "chat.toolLoop":       { status: WEB_STATUS.PARTIAL,         label: "Chat tools (search/image)", message: "Web chat supports web search, fetch, image generation, deep research, memory, and MCP connector tools; a few desktop tools are still being ported." },
  ...
  "research.deep":       { status: WEB_STATUS.PARITY,         label: "Deep research",             message: "" },
  ...
  "mcp.connectors":      { status: WEB_STATUS.SERVICE,         label: "MCP connectors",            message: "Connectors run via Madav's managed service. Remote MCP servers work on web; local (stdio) connectors are desktop-only." },
