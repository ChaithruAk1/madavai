...
export const webBridge = {
  ...
  media: { image: async () => ({ error: "Image generation runs in the Madav desktop app." }), imageEdit: async () => ({ error: "Image editing runs in the Madav desktop app." }), speech: async () => ({ error: "Voice runs in the Madav desktop app." }), transcribe: async () => ({ error: "Voice runs in the Madav desktop app." }), video: async () => ({ error: "Video runs in the Madav desktop app." }) },
