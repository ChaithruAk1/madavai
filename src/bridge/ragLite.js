// src/bridge/ragLite.js — client-side "RAG-lite" for project knowledge (Phase 2). No embeddings: lexical
// chunk + keyword-overlap ranking. Two goals: (1) NEVER dump unbounded knowledge into the system prompt
// (token blow-up), and (2) when the user's question is known, surface the MOST RELEVANT passages first.
// Pure -> unit-tested. Falls back to whole-doc injection for small knowledge so existing behavior is unchanged.
