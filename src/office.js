...
async function buildXlsxTemplate(spec) {
  ...
  if (charts && charts.length) { try { const ch = await import("./doc/xlsxChart.js"); buf = await ch.injectCharts(buf, charts); } catch (e) { console.warn("[office] chart injection failed:", (e && e.message) || e); } }
