...
description: Analyze an unfamiliar codebase and generate a structured onboarding guide with architecture map, key entry points, conventions, and a starter MADAV.md. Use when joining a new project or setting up Madav for the first time in a repo.
origin: ECC
---

# Codebase Onboarding

Systematically analyze an unfamiliar codebase and produce a structured onboarding guide. Designed for developers joining a new project or setting up Madav in an existing repo for the first time.

## When to Use

- First time opening a project with Madav
- Joining a new team or repository
- User asks "help me understand this codebase"
- User asks to generate a MADAV.md for a project
...
#### Output 2: Starter MADAV.md

Generate or update a project-specific MADAV.md based on detected conventions. If `MADAV.md` already exists, read it first and enhance it — preserve existing project-specific instructions and clearly call out what was added or changed.
...
3. **Respect existing MADAV.md** — if one already exists, enhance it rather than replacing it. Call out what's new vs existing.
...
- Generating a MADAV.md that's longer than 100 lines — keep it focused
...
**Action**: Run full 4-phase workflow → produce Onboarding Guide + Starter MADAV.md
**Output**: Onboarding Guide printed directly to the conversation, plus a `MADAV.md` written to the project root

### Example 2: Generate MADAV.md for existing project
**User**: "Generate a MADAV.md for this project"
**Action**: Run Phases 1-3, skip Onboarding Guide, produce only MADAV.md
**Output**: Project-specific `MADAV.md` with detected conventions

### Example 3: Enhance existing MADAV.md
**User**: "Update the MADAV.md with current project conventions"
**Action**: Read existing MADAV.md, run Phases 1-3, merge new findings
**Output**: Updated `MADAV.md` with additions clearly marked
