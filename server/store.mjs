...
const COLLECTIONS = ["shares", "requests", "threads", "posts", "workspaces", "conversations", "conntokens"]; // workspaces: per-user synced agents/teams/groups (record id = userId); conntokens: per-user encrypted connector tokens (record id = "conntok:<userId>")
