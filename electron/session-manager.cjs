...
function isDeckCapable(model) {
  ...
  return /(opus|sonnet|gpt-?5|gpt-?4|4o|\bo1\b|\bo3\b|gemini-(?:1\.5-pro|2|exp|pro)|deepseek|grok|32b|70b|72b|120b|123b|235b|405b|mistral-large|command-r-plus|qwen2?\.5-(?:32|72))/.test(m); // clearly-capable → bespoke; unknown → template
}
