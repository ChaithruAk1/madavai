...
contextBridge.exposeInMainWorld("brainedge", {
  ...
  winSpeech: (args) => ipcRenderer.invoke("brainedge:winSpeech", args),
  getModelStats: () => ipcRenderer.invoke("brainedge:getModelStats"),
  getUserMemory: () => ipcRenderer.invoke("brainedge:getUserMemory"),
  setUserMemory: (notes) => ipcRenderer.invoke("brainedge:setUserMemory", notes),
  clearUserMemory: () => ipcRenderer.invoke("brainedge:clearUserMemory"),
